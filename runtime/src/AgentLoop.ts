...
function buildSystemPrompt(
  ...
  const sections = [
    ...
    `- **Web search**: Use DuckDuckGo for searching: browse_web({"url": "https://duckduckgo.com/?q=your+search+terms"})`,
    `- **NEVER use Google for searching** — it will CAPTCHA/block you. Always use DuckDuckGo.`,
